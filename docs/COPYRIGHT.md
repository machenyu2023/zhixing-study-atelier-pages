...
知识课的章节组织与训练路径参考用户提供的《逻辑 · 写作 · 思考 — 每日训练习题册》和《逻辑 · 论证 · 思考 — 系统学习手册》。站内课程没有逐页复制原文，而是对概念进行重新提炼、表述，并使用原创案例与题目组织练习。

两份原始 PDF 不纳入本仓库、不随 GitHub Pages 分发。其著作权及相关权利归原权利人所有；本项目中的来源说明不构成对原材料再分发的授权。
