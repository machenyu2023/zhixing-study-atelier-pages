...
- 二十四个独立撰写的教学条目：覆盖立体角、能量守恒、光谱量、偏振、辐射传输、大气窗口、BRDF、TOA/SR、Planck/亮温、LST、主动/被动微波、极化、土壤水分、冠层、前向模型、敏感性、反演、传感器定标、噪声和质量标识。其来源支持范围与教学简化均分别标注，不视为完整课程或已完成 ATBD 审读。
...
- `docs/remote-sensing/模型对比初稿.md` 开始记录大气传输、BRDF、LST、介电模型和反演路线的差异。
