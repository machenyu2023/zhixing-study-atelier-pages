...
const assetFiles = ["styles.css", "app.js", "exam-export.js", "workbook-bank.js", "curriculum-renderer.js", "storage.js", "config.js", "remote-sensing.js", "remote-sensing.css"];

if (fileURLToPath(dist) !== join(fileURLToPath(root), "dist") + (process.platform === "win32" ? "\\" : "/")) {
...
await cp(new URL("docs/remote-sensing/", root), new URL("docs/remote-sensing/", dist), { recursive: true });
